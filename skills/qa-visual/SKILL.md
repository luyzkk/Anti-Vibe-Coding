---
name: qa-visual
description: "QA visual no browser real via Playwright MCP: layout, fluxo do usuario, rede, erros de console, acessibilidade, responsividade e performance. Use apos concluir feature de frontend — 'testar no navegador', 'QA visual', 'run QA'."
user-invocable: true
