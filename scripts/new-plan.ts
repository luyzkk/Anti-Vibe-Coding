#!/usr/bin/env bun
// 2026-05-13 (Luiz/dev): scaffold de novos execution plans.
// Porta do new-plan.mjs do harness-engineering (André Prado) para TS + bun.
// Gera arquivo em docs/exec-plans/active/{YYYY-MM-DD}-{slug}.md com as 10 secoes do template D18.
...
if (!title) {
  console.error('Usage: bun run new-plan "Plan title"')
  process.exit(1)
}
