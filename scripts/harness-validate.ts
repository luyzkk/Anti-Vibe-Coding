...
const LEGACY_V5_SKILLS = new Set([
  ...
  // 2026-08-12: removido da whitelist:
  //   skills/lessons-learned/SKILL.md — o passo 4b passou a inferir a origem de
  //   docs/exec-plans/{completed,active}/ em vez de .planning/_archive/
])
